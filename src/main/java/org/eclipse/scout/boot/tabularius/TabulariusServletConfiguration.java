...
@Controller
@RequestMapping("/")
public class TabulariusServletConfiguration extends AbstractMinimalScoutBootServletConfiguration {
	...
	@Configuration
	public class TabulariusMvcEndpoint extends AbstractMinimalScoutUIiServletMvcEndpoint {
